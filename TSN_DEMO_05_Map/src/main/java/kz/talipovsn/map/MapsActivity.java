...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.2811823,76.9694253); // Начальный маркер
    static final LatLng marker1 = new LatLng(52.2760463,76.9706906); // Маркер Каспи Банка
    static final LatLng marker2 = new LatLng(52.2761201,76.9695599); // Маркер Халык Банка
    static final LatLng marker3 = new LatLng(52.2834409,76.9715221); // Маркер Банка Хоум Кредит
    static final LatLng marker4 = new LatLng(52.2756535,76.9697155); // Маркер Евразийского Банка
    static final LatLng marker5 = new LatLng(52.2807556,76.9620631); // Маркер Альфа Банка
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.hlk)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker3).title((getString(R.string.marker3_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.hc)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.alph)).alpha(ALPHA).
